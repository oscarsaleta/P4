...
QViewDlg::QViewDlg( QWidget * parent )
    : QWidget(parent=NULL,Qt::Tool | Qt::WindowStaysOnTopHint)
{
//  setFont( QFont( FONTSTYLE, FONTSIZE ) );
...
#ifdef TOOLTIPS
    btn_sphere->setToolTip( "Spherical projection of the plane (Poincare or Poincare-Lyapunov)" );
    btn_plane->setToolTip( "Planar view of a compact, rectangular region in the plane" );
    ...
    edt_projection->setToolTip( "Choose projection point of the Poincare sphere.\n"
    ...
    btn_square->setToolTip( "Fills fields MinY, MaxX, MaxY with MinX,-MinX,-MinX respectively,\nto make a square rectangle around the origin." );
#endif
   ...
   setLayout(mainLayout);
    ...
    QObject::connect( btn_sphere,       SIGNAL(toggled(bool)), this, SLOT(btn_sphere_toggled(bool)) );
    QObject::connect( btn_plane,        SIGNAL(toggled(bool)), this, SLOT(btn_plane_toggled(bool)) );
    QObject::connect( btn_U1,           SIGNAL(toggled(bool)), this, SLOT(btn_U1_toggled(bool)) );
    QObject::connect( btn_U2,           SIGNAL(toggled(bool)), this, SLOT(btn_U2_toggled(bool)) );
    QObject::connect( btn_V1,           SIGNAL(toggled(bool)), this, SLOT(btn_V1_toggled(bool)) );
    QObject::connect( btn_V2,           SIGNAL(toggled(bool)), this, SLOT(btn_V2_toggled(bool)) );
    QObject::connect( btn_square,       SIGNAL(clicked()), this, SLOT(btn_square_clicked()) );
    QObject::connect( edt_projection,   SIGNAL(textChanged(const QString &)), this, SLOT(OnFieldChange(const QString &)) );
    QObject::connect( edt_x0,           SIGNAL(textChanged(const QString &)), this, SLOT(OnFieldChange(const QString &)) );
    QObject::connect( edt_x1,           SIGNAL(textChanged(const QString &)), this, SLOT(OnFieldChange(const QString &)) );
    QObject::connect( edt_y0,           SIGNAL(textChanged(const QString &)), this, SLOT(OnFieldChange(const QString &)) );
    QObject::connect( edt_y1,           SIGNAL(textChanged(const QString &)), this, SLOT(OnFieldChange(const QString &)) );
...
{
    changed=true;
    ExclusiveToggle( on, btn_sphere, btn_plane, btn_U1, btn_U2, btn_V1, btn_V2, NULL );
...
{
    changed=true;
    ExclusiveToggle( on, btn_plane, btn_sphere, btn_U1, btn_U2, btn_V1, btn_V2, NULL );
...
{
    changed=true;
    ExclusiveToggle( on, btn_U1, btn_plane, btn_sphere, btn_U2, btn_V1, btn_V2, NULL );
...
{
    changed=true;
    ExclusiveToggle( on, btn_U2, btn_plane, btn_sphere, btn_U1, btn_V1, btn_V2, NULL );
...
{
    changed=true;
    ExclusiveToggle( on, btn_V1, btn_plane, btn_sphere, btn_U1, btn_U2, btn_V2, NULL );
...
{
    changed=true;
    ExclusiveToggle( on, btn_V2, btn_plane, btn_sphere, btn_U1, btn_U2, btn_V1, NULL );
...
void QViewDlg::ExclusiveToggle( bool on, QRadioButton * first, ... )
{
    ...
    else
    {
        ...
        va_end( marker );
        if( onbtn == NULL || onbtn == first )
            first->toggle();
    }
}

bool QViewDlg::ReadFloatField( QLineEdit * edt, double * presult,
...
bool QViewDlg::GetDataFromDlg( void )
{
    ...
    changed |= ReadFloatField( edt_projection, &(VFResults.config_projection),
                        DEFAULT_PROJECTION, MIN_PROJECTION, MAX_PROJECTION );
    changed |= ReadFloatField( edt_x0, &(VFResults.xmin),
                        X_MIN, MIN_FLOAT, MAX_FLOAT );
    changed |= ReadFloatField( edt_y0, &(VFResults.ymin),
                        Y_MIN, MIN_FLOAT, MAX_FLOAT );
    changed |= ReadFloatField( edt_x1, &(VFResults.xmax),
                        X_MAX, MIN_FLOAT, MAX_FLOAT );
    changed |= ReadFloatField( edt_y1, &(VFResults.ymax),
                        Y_MAX, MIN_FLOAT, MAX_FLOAT );
...
void QViewDlg::UpdateDlgData( void )
{
    ...
    if( VFResults.typeofview == TYPEOFVIEW_PLANE )
        ExclusiveToggle( true, btn_plane, btn_sphere, btn_U1, btn_U2, btn_V1, btn_V2, NULL );
    if( VFResults.typeofview == TYPEOFVIEW_SPHERE )
        ExclusiveToggle( true, btn_sphere, btn_plane, btn_U1, btn_U2, btn_V1, btn_V2, NULL );
    if( VFResults.typeofview == TYPEOFVIEW_U1 )
        ExclusiveToggle( true, btn_U1, btn_sphere, btn_plane, btn_U2, btn_V1, btn_V2, NULL );
    if( VFResults.typeofview == TYPEOFVIEW_U2 )
        ExclusiveToggle( true, btn_U2, btn_sphere, btn_plane, btn_U1, btn_V1, btn_V2, NULL );
    if( VFResults.typeofview == TYPEOFVIEW_V1 )
        ExclusiveToggle( true, btn_V1, btn_sphere, btn_plane, btn_U1, btn_U2, btn_V2, NULL );
    if( VFResults.typeofview == TYPEOFVIEW_V2 )
        ExclusiveToggle( true, btn_V2, btn_sphere, btn_plane, btn_U1, btn_U2, btn_V1, NULL );
