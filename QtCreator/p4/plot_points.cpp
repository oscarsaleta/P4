...
void win_plot_saddle(QPainter *p, int x, int y)
{
    ...
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_saddle));
    p->setBrush(P4Colours::p4XfigColour(P4ColourSettings::colour_saddle));
...
{
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_node_stable));
    p->setBrush(P4Colours::p4XfigColour(P4ColourSettings::colour_node_stable));
    p->drawRect(x - SYMBOLWIDTH / 2, y - SYMBOLHEIGHT / 2, SYMBOLWIDTH,
                SYMBOLHEIGHT);
}
...
{
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_node_unstable));
    p->setBrush(
        P4Colours::p4XfigColour(P4ColourSettings::colour_node_unstable));
    p->drawRect(x - SYMBOLWIDTH / 2, y - SYMBOLHEIGHT / 2, SYMBOLWIDTH,
                SYMBOLHEIGHT);
}
...
{
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_weak_focus));
    p->setBrush(P4Colours::p4XfigColour(P4ColourSettings::colour_weak_focus));
    QPolygon qpa(4);
...
{
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_center));
    p->setBrush(P4Colours::p4XfigColour(P4ColourSettings::colour_center));
    QPolygon qpa(4);
    qpa.setPoints(4, x, y - SYMBOLHEIGHT / 2, x + SYMBOLWIDTH / 2, y, x,
                  y + SYMBOLHEIGHT / 2, x - SYMBOLWIDTH / 2, y);
...
{
    p->setPen(P4Colours::p4XfigColour(
        P4ColourSettings::colour_strong_focus_unstable));
    p->setBrush(P4Colours::p4XfigColour(
        P4ColourSettings::colour_strong_focus_unstable));
    QPolygon qpa(4);
    qpa.setPoints(4, x, y - SYMBOLHEIGHT / 2, x + SYMBOLWIDTH / 2, y, x,
                  y + SYMBOLHEIGHT / 2, x - SYMBOLWIDTH / 2, y);
...
{
    QPolygon qpa(3);
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_saddle_node));
    p->setBrush(P4Colours::p4XfigColour(P4ColourSettings::colour_saddle_node));
...
{
    p->setPen(P4Colours::p4XfigColour(P4ColourSettings::colour_degen));
