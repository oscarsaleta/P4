...
//  setFont( QFont( FONTSTYLE, FONTSIZE ) );
    ...
    btn_actionrun->setToolTip( "Make sure the symbolic manipulator processes the file" );
    btn_actionprep->setToolTip( "Do not process the file, only prepare it.\n"
    ...
    btn_yes->setToolTip( "The View/Finite and View/Infinite windows will display more details" );
    btn_no->setToolTip(  "The View/Finite and View/Infinite windows will display no details" );
    ...
    btn_eval->setToolTip( "Prepare a file for the symbolic manipulator, and optionally process it" );
#endif
...
//   mainLayout->setSizeConstraint(QLayout::SetFixedSize);
    ...
    {
    case TYPEOFSTUDY_ALL:   btn_all->toggle(); break;
    case TYPEOFSTUDY_FIN:   btn_fin->toggle(); break;
    case TYPEOFSTUDY_INF:   btn_inf->toggle(); break;
    case TYPEOFSTUDY_ONE:   btn_one->toggle(); break;
    }
    ...
    QObject::connect( btn_maple,    SIGNAL(toggled(bool)), this, SLOT(btn_maple_toggled(bool)) );
    QObject::connect( btn_reduce,   SIGNAL(toggled(bool)), this, SLOT(btn_reduce_toggled(bool)) );
    QObject::connect( btn_actionrun,    SIGNAL(toggled(bool)), this, SLOT(btn_actionrun_toggled(bool)) );
    QObject::connect( btn_actionprep,   SIGNAL(toggled(bool)), this, SLOT(btn_actionprep_toggled(bool)) );
    QObject::connect( btn_all,  SIGNAL(toggled(bool)), this, SLOT(btn_all_toggled(bool)) );
    QObject::connect( btn_one,  SIGNAL(toggled(bool)), this, SLOT(btn_one_toggled(bool)) );
    QObject::connect( btn_fin,  SIGNAL(toggled(bool)), this, SLOT(btn_fin_toggled(bool)) );
    QObject::connect( btn_inf,  SIGNAL(toggled(bool)), this, SLOT(btn_inf_toggled(bool)) );
    QObject::connect( btn_yes, SIGNAL(toggled(bool)), this, SLOT(btn_yes_toggled(bool)) );
    QObject::connect( btn_no, SIGNAL(toggled(bool)), this, SLOT(btn_no_toggled(bool)) );
...
void QFindDlg::UpdateDlgData( void )
{
    switch( ThisVF->typeofstudy )
    {
    case TYPEOFSTUDY_ALL:   ExclusiveToggle( true, btn_all ); break;
    case TYPEOFSTUDY_FIN:   ExclusiveToggle( true, btn_fin ); break;
    case TYPEOFSTUDY_INF:   ExclusiveToggle( true, btn_inf ); break;
...
void QFindDlg::Signal_Evaluating( void )
{
    btn_eval->setEnabled(false);
}

void QFindDlg::Signal_Evaluated( void )
{
