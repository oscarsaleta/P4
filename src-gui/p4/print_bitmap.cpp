...
static void P4Print_print_saddle(double _x, double _y)
{
    ...
    // print box:
    P4PrintPainter->drawRect(x - P4PrintSymbolWidth / 2,
                             y - P4PrintSymbolWidth / 2, P4PrintSymbolWidth,
                             P4PrintSymbolWidth);
}
...
static void P4Print_print_stableweakfocus(double _x, double _y)
{
    ...
    QPolygon qpa(4);
    qpa.setPoints(4, x, y - P4PrintSymbolWidth * 13 / 20,
                  x + P4PrintSymbolWidth * 13 / 20, y, x,
                  y + P4PrintSymbolWidth * 13 / 20,
                  x - P4PrintSymbolWidth * 13 / 20, y);
...
static void P4Print_print_sesaddle(double _x, double _y)
{
    ...
    QPolygon qpa(3);
    qpa.setPoints(
        3, x - P4PrintSymbolWidth * 12 / 20, y + P4PrintSymbolWidth * 12 / 20,
        x + P4PrintSymbolWidth * 12 / 20, y + P4PrintSymbolWidth * 12 / 20, x,
        y - P4PrintSymbolWidth * 12 / 20);
    P4PrintPainter->drawPolygon(qpa, Qt::OddEvenFill);
}
...
static void P4Print_print_degen(double _x, double _y)
{
    ...
    P4PrintPainter->drawLine(
        x - P4PrintSymbolWidth / 2, y - P4PrintSymbolWidth / 2,
        x + P4PrintSymbolWidth / 2, y + P4PrintSymbolWidth / 2);
    P4PrintPainter->drawLine(
        x + P4PrintSymbolWidth / 2, y - P4PrintSymbolWidth / 2,
        x - P4PrintSymbolWidth / 2, y + P4PrintSymbolWidth / 2);
                                ...
                                struct P4POLYLINES *ellipse)
{
    ...
    while (ellipse != nullptr) {
        P4PrintPainter->drawLine((int)(ellipse->x1), (int)(ellipse->y1),
                       ...
                       int linewidth, int symbolwidth)
{
    ...
    p4paint->fillRect(0, 0, w, h,
                      QBrush(QXFIGCOLOR(printColorTable[CBACKGROUND])));
}
